...
public class SpannerService : ISpannerService
{
    ...
    private void SeedData()
    {
        ...
        // Real Local Places from Pongalur, Devanampalayam, and Highway perimeter
        if (!_entities.ContainsKey("ent-hotel-apoorva"))
        {
            _entities["ent-hotel-apoorva"] = new Entity
            {
                EntityId = "ent-hotel-apoorva",
                EntityType = "PLACE",
                Category = "🍴 HIGHWAY DINING & RESTAURANT",
                Name = "Hotel Apoorva",
                Description = "Tiruppur-Dharapuram National Highway, Pongalur. Authentic South Indian meals, tiffin, and family dining.",
                ...
                Locations = new List<EntityLocation>
                {
                    ...
                    {
                        EntityId = "ent-hotel-apoorva",
                        LocationId = "loc-apoorva-1",
                        Name = "Pongalur Highway Branch",
                        AddressLine1 = "Tiruppur - Dharapuram Highway, Pongalur",
                        City = "Pongalur",
                        State = "Tamil Nadu",
                        Latitude = 10.9835,
                        Longitude = 77.4020,
                ...
                CriteriaAverages = new Dictionary<string, double>
                {
                    ["Quality / Taste"] = 4.7,
                    ["Service & Staff"] = 4.5,
                    ["Cleanliness & Ambience"] = 4.6,
                    ["Pricing & Value"] = 4.6
                }
            };

            _entities["ent-hotel-ariyas"] = new Entity
            {
                EntityId = "ent-hotel-ariyas",
                EntityType = "PLACE",
                Category = "🍴 SOUTH INDIAN RESTAURANT",
                Name = "Hotel Ariyas pongalur",
                Description = "Main Road, Pongalur Junction. Crispy roast dosas, idli vada, and filter coffee.",
                ...
                Locations = new List<EntityLocation>
                {
                    ...
                    {
                        EntityId = "ent-hotel-ariyas",
                        LocationId = "loc-ariyas-1",
                        Name = "Pongalur Town",
                        AddressLine1 = "Main Road, Near Bus Stop, Pongalur",
                        City = "Pongalur",
                        State = "Tamil Nadu",
                        Latitude = 10.9845,
                        Longitude = 77.4075,
            ...
            _entities["ent-abhi-cakes"] = new Entity
            {
                EntityId = "ent-abhi-cakes",
                EntityType = "PLACE",
                Category = "🍰 BAKERY & CONFECTIONERY",
                Name = "ABHI Cakes",
                Description = "Pongalur Highway. Fresh pastries, birthday cakes, puffs, and cold beverages.",
                ...
                Locations = new List<EntityLocation>
                {
                    ...
                    {
                        EntityId = "ent-abhi-cakes",
                        LocationId = "loc-abhi-1",
                        Name = "Pongalur Branch",
                        AddressLine1 = "Highway Junction, Pongalur",
                        City = "Pongalur",
                        State = "Tamil Nadu",
                        Latitude = 10.9830,
                        Longitude = 77.4110,
            ...
            _entities["ent-k2v-fastfood"] = new Entity
            {
                EntityId = "ent-k2v-fastfood",
                EntityType = "PLACE",
                Category = "🍟 FAST FOOD & CHINESE",
                Name = "K2V FAST FOOD 2",
                Description = "Near Karappalayam Road Junction, Pongalur. Fried rice, noodles, chappathi, and evening snacks.",
                ...
                Locations = new List<EntityLocation>
                {
                    ...
                    {
                        EntityId = "ent-k2v-fastfood",
                        LocationId = "loc-k2v-1",
                        Name = "Pongalur East",
                        AddressLine1 = "Dharapuram Highway, Pongalur",
                        City = "Pongalur",
                        State = "Tamil Nadu",
                        Latitude = 10.9820,
                        Longitude = 77.4150,
            ...
            _entities["ent-shanthi-mahal"] = new Entity
            {
                EntityId = "ent-shanthi-mahal",
                EntityType = "PLACE",
                Category = "🏛️ BANQUET & MARRIAGE HALL",
                Name = "Sri Shanthi Mahal",
                Description = "Singanurpudur Road, Pongalur. Spacious marriage and event hall with ample car parking.",
                ...
                Locations = new List<EntityLocation>
                {
                    ...
                    {
                        EntityId = "ent-shanthi-mahal",
                        LocationId = "loc-shanthi-1",
                        Name = "Singanurpudur",
                        AddressLine1 = "Singanurpudur Road, Pongalur",
                        City = "Pongalur",
                        State = "Tamil Nadu",
                        Latitude = 10.9890,
                        Longitude = 77.4040,
                ...
                {
                    ["Ambience & Space"] = 4.9,
                    ["Amenities & Parking"] = 4.8,
                    ["Maintenance"] = 4.7
                }
            };

            _entities["ent-twins-day"] = new Entity
            {
                EntityId = "ent-twins-day",
                EntityType = "PLACE",
                Category = "☕ CAFE & BEVERAGES",
                Name = "Twins Day",
                Description = "Tiruppur-Dharapuram Highway, Pongalur. Fresh juices, shakes, hot tea, and snacks.",
                ...
                Locations = new List<EntityLocation>
                {
                    ...
                    {
                        EntityId = "ent-twins-day",
                        LocationId = "loc-twins-1",
                        Name = "Pongalur Highway",
                        AddressLine1 = "Main Highway, Pongalur",
                        City = "Pongalur",
                        State = "Tamil Nadu",
                        Latitude = 10.9840,
                        Longitude = 77.4050,
